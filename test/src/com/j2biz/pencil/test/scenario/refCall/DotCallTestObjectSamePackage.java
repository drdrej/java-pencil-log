 ...
 */
public class DotCallTestObjectSamePackage {
       public Person publicField = new Person(1);
	   
       protected int protectedField = new Integer(2).intValue();
	   
	   private int privateField = new Integer(3).intValue();
	   
	   int defaultField = new Integer(6).intValue();
	   
	   public class SubClass1 {
		   public class SubClass2 {
			   public Person subClassPublicField = new Person(4);
		   }
	   }
}
