...
public class DeepEnclosingClasses {
	...
	private static String field = new String("testField");
	...
	class Class1 {
		...
		class Class2 {
			...
			class Class3 {
				{
					TestLog.debug("DeepEnclosingClasses.Class1.Class2.Class3.<init> = ok");
					TestLog.debug("DeepEnclosingClasses.Class1.Class2.Class3.<init>.field = " + field);
				}
			}
		}
	}
	...
	static class NestedClass1 {
		...
		static class NestedClass2 {
			...
			static class NestedClass3 {
				{
					TestLog.debug("DeepEnclosingClasses.NestedClass1.NestedClass2.NestedClass3.<init> = ok");
					TestLog.debug("DeepEnclosingClasses.NestedClass1.NestedClass2.NestedClass3.<init>.field = " + field);
				}
			}
		}
	}
