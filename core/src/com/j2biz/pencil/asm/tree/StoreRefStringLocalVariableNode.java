...
public class StoreRefStringLocalVariableNode implements Node, Acceptable{

	private final int varIdx;
	
	public StoreRefStringLocalVariableNode(int varIndex) {
		Assert.indexIsNotLessThanZero(varIndex);
